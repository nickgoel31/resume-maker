          ...
          [
            {
              stack: [
                ...
                ...educations.map(education => {
                  return [
                    { text: `${education.degree}`, bold: true, fontSize: 16},
                    { text: `${education.institution}`,bold: true, fontSize: 16 },
                    // { text: `Description: ${education.major}` },
                    { text: `Start Date: ${education.startDate?.getFullYear()}` },
                    { text: `End Date: ${education.endDate?.getFullYear()}` },
