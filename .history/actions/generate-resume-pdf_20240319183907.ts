            ...
            // Experiences and Summary
            {
              stack: [
                ...
                ...experiences.map(experience => {
                  ...
                  return [
                    { text: "", margin: [0, 6, 0, 0] }, 
                    { text: `${experience.startDate?.getFullYear()}, ${startMonth} - ${experience.endDate?.getFullYear()}, ${endMonth}`, opacity: 0.6 },
                    { text: `${experience.company}`, opacity: 0.6 },
                    { text: `${experience.jobTitle}`, bold: true, fontSize: 15, },
                    { text: `${experience.description}`, opacity: 0.6 },
