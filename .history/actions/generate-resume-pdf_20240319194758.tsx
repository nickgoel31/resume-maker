...
const profileSvg = (profileUrl: string) => {
  return `
    <svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
      ...
      <image xlink:href="${profileUrl}" width="100" height="100" clip-path="url(#circleClip)" />
    </svg>
  `;
}
        ...
        body: [
          [
            // Profile Picture
            {
              stack: [
                // {
                //   image: `data:image/svg+xml;utf8,${encodeURIComponent(profileSvg(profileUrl))}`,
