...
export const generateResumePDFTheme = (values: z.infer<typeof formSchema>, experiences: Experience[], educations: Education[], profileUrl: string, skills: Skill[],theme?: number | 1) => {
