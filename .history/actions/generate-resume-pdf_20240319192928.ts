...
export const generateResumePDF = (values: z.infer<typeof formSchema>, experiences: Experience[], educations: Education[], profileUrl: string, skills: Skill[]) => {
  const background = 'https://png.pngtree.com/thumb_back/fh260/back_our/20190621/ourmid/pngtree-my-resume-background-material-image_177383.jpg';
  const content = [

    { image: background, width: 595, height: 842, absolutePosition: { x: 0, y: 0 } }, // Adjust width and height as needed
        ...
        body: [
          [
            ...
            // Name as heading
            {
              ...
              style: "nameHeading",
              alignment: 'left',
              margin: [0, 60, 0, 10] // Adjust margin for vertical alignment
            }
          ]
        ]
      }
