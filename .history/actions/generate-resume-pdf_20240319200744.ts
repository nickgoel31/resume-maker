...
export const generateResumePDF = (values: z.infer<typeof formSchema>, experiences: Experience[], educations: Education[], profileUrl: string, skills: Skill[]) => {
  ...
  const backgroundImage = `
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      <image href="${"https://png.pngtree.com/thumb_back/fh260/back_our/20190621/ourmid/pngtree-my-resume-background-material-image_177383.jpg"}" width="100%" height="100%" />
    </svg>
  `;
        ...
        body: [
          [
            ...
            // Name as heading
            {
              ...
              style: "nameHeading",
              alignment: 'left',
              margin: [15, 40, 10, 16] // Adjust margin for vertical alignment
            }
          ]
        ]
      }
