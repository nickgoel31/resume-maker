            ...
            <div className="flex flex-col items-center gap-3 w-full">
                ...
                <div className='flex items-center gap-3 w-full'>
                    <div className='flex flex-col gap-1 w-full'>
                        ...
                        <DatePicker selected={startDate} className='border rounded p-1 w-full px-3 text-sm font-medium' onChange={(date) => setStartDate(date)} />
                    </div>
                    <div className='flex flex-col gap-1 w-full'>
                        <label htmlFor="" className='font-medium text-sm'>End Date</label>
                        <DatePicker selected={endDate} className='border rounded p-1 w-full px-3 text-sm font-medium' onChange={(date) => setEndDate(date)} />
                    </div>
                </div>
