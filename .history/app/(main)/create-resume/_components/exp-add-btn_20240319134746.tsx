...
const ExpAddBtn = ({onExperienceAdd}:{onExperienceAdd: (experience:any) => void}) => {
    ...
    const handleAddExperience = () => {
        ...
        onExperienceAdd(experience); // Call the function passed from the parent with the experience object
    }
        ...
        <DialogContent>
            ...
            <div className="flex flex-col items-center gap-3 w-full">
                ...
                <div className='flex flex-col gap-1 w-full'>
                    ...
                    <Input type="text" placeholder='e.g., Software Engineer Intern' onChange={(e) => set(e.target.value)}/>
                </div>
                <div className='flex flex-col gap-1 w-full'>
                    <label htmlFor="" className='font-medium text-sm'>Description</label>
                    <Textarea placeholder='e.g., Software Engineer Intern' onChange={(e) => setJobTitle(e.target.value)} />
                </div>
