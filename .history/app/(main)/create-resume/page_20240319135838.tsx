                ...
                <div className="section-1 space-y-4">
                    ...
                    <div className="grid grid-cols-3 w-full gap-3">
                        {experiences.map((experience, index) => (
                            <div className="add-btn rounded border p-3 bg-white text-sm font-semibold flex gap-4 items-center justify-between">
                                <div>
                                    {experience.jobTitle}
                                </div>
                                <div>
                                    <Trash2 size={15} onClick={() => deleteExperience(index)} className="text-red-500"/>
                                </div>
                            </div>
                        ))}
