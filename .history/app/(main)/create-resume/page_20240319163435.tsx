...
import { DetailedHTMLProps, InputHTMLAttributes, LegacyRef, MutableRefObject, useEffect, useRef, useState } from "react"
...
const CreateResumePage = () => {
    ...
    const profilePic = useRef<DetailedHTMLProps<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>>()
    ...
    <body className='h-full w-full bg-slate-50 flex items-center justify-center gap-8 flex-col py-10 px-5'>
        ...
        <input type="file" accept=".jpeg,.png,.webp,.jpg" id="#profilepic"/> 
