...
const CreateResumePage = () => {
    ...
    const [skills, setEducations] = useState<Education[]>([])
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        if (selectedFile) {
            ...
            fr.onload = () => {
                ...
                generateResumePDF(values, experiences, educations, profileUrl);
                // setEducations([])
                // setExperiences([])
            };
        } else {
    ...
    <body className='h-full w-full bg-slate-50 flex items-center justify-center gap-8 flex-col py-10 px-5'>
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full max-w-screen-sm">
                ...
                {/* SECTION 4 */}
                <div className="section-1 space-y-4">
                    <h3 className="text-semibold font-semibold text-lg">3. Add Skills</h3>
